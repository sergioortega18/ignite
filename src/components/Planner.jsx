...
const Planner = () => {
    return (
        <div className='flex flex-col items-center sm:flex-row border border-gray-300 p-4 p4 md:py-32 lg:pt-40  md:gap-24'>
            ...
            <div className='w-full sm:w-1/2 flex items-center justify-center pb-0 sm:py-0'>
                ...
                <div className='text-[#414141] flex flex-col lg:p-6 '>
                    ...
                    <div className='flex items-center gap-2 text-base'>
                        <p className='font-medium text-sm md:text-2xl leading-tight'>PLANEACION ESTRATEGICA</p>
